...
class Recorder {
    ...
    // pcm数据回调
    public onPCM: (lData: Float32Array, rData: Float32Array) => void; 
    /**
    ...
    constructor(options: recorderConfig = {}) {
        ...
        console.log('inputSampleRate ', this.inputSampleRate, 'options.sampleRate ', options.sampleRate);
        // 配置config，检查值是否有问题
        this.config = {
            // 采样数位 8, 16
